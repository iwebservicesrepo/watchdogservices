    ...
    <body style="background-color: #e9ecef !important;">
        <div class="jumbotron text-center" style="text-align:center;padding: 20px;">
            ...
            <p style="text-align: left;">
                Thank you for purchasing title protection from WatchDog Title services.<br>
                Here is your Customer Code: <b>{{ $customer_code }}</b> <br>
                Please save this in your records. We will also have it on file.
            </p>
