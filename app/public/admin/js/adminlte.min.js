...
!function (e, t) {
    ...
    var n = a(t),
            ...
            f = function () {
                function e(e, t) {
                    if (this._element = e, this._parent = e.parents(".card").first(), this._settings = n.default.extend({}, d, t), this._overlay = n.default(this._settings.overlayTemplate), e.hasClass(l) && (this._parent = e), "" === this._settings.source)
                ...
                return t.collapse = function () {
                    ...
                    if (e.hasClass(A)) {
                        ...
                        if (0 === o && 0 === i)
                            ...
                            o <= a.header ? !1 === s ? (t.css("top", a.header - o), r.css("height", a.window - (a.header - o))) : t.css("top", a.header) : !1 === s ? (t.css("top", 0), r.css("height", a.window)) : t.css("top", a.header);
            ...
            Qe = function () {
                ...
                return t.onTabClick = function (e) {
                    ...
                    if ("all" == e)
                        ...
                        if (i.remove(), n.default("#" + l).remove(), n.default(be).children().length == n.default(ye + ", " + Ce).length)
                            n.default(ye).show();
                        else {
                            var r = s - 1;
